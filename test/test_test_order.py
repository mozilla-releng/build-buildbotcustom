...
class TestTestOrder(unittest.TestCase):
    ...
    def test_singleRequest(self):
        # Easy peasy
        c1 = Change(
            who='me!', branch='b1', revision='1', files=['http://path/to/build'],
    ...
    def test_threeRequests(self):
        ...
        c1 = Change(
            who='me!', branch='b1', revision='r3', files=['http://path/to/build'],
                comments='really important', properties={'buildid': '20110214000003'}, when=4)
        c2 = Change(
            who='me!', branch='b1', revision='r2', files=['http://path/to/build'],
