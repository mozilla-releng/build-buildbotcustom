...
RESULT_DEFAULT = ['Linux tryserver leak test build', 'Linux x86-64 tryserver leak test build', 'OS X 10.5.2 tryserver leak test build', 'OS X 10.6.2 tryserver leak test build', 'WINNT 5.2 tryserver leak test build', 'Android R7 tryserver build', 'Maemo 4 tryserver build', 'Maemo 5 GTK tryserver build', 'Maemo 5 QT tryserver build']

# Test Bad data:
MESSAGE_BUILD_JUNK = "try: --build junk --p linux" 
RESULT_JUNK = ['Linux tryserver build', 'Android R7 tryserver build', 'Maemo 4 tryserver build', 'Maemo 5 GTK tryserver build', 'Maemo 5 QT tryserver build']

# SPECIFYING opt/debug
MESSAGE_BUILD_D = "try: --build d --p linux"
MESSAGE_BUILD_O = "try: --build o --p linux"
MESSAGE_BUILD_DO = "try: --build do --p linux"
...
# SPECIFIC PLATFORMS
MESSAGE_MAC_ONLY = "try: --build o --p macosx,macosx64 --m none"
...
MESSAGE_MOBILE_ONLY = "try: --p none"
...
MESSAGE_MOBILE_SELECT = "try: --p none --m android-r7,maemo4,maemo5-qt"
...
MESSAGE_ALL_TALOS = "try: --build o --t all"
MESSAGE_SELECT_TALOS = "try: --build o --p linux --t scroll,dromaeo,tp4"
