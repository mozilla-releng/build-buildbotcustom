...
def addMockCommand(obj):
  ...
  class C(obj):
      def __init__(self, mock=False, mock_login='mock_mozilla',
          ...
          self.makeCmd = kwargs.get('makeCmd', 'make')
          self.mock_workdir_prefix = mock_workdir_prefix
...
MockMozillaPackagedMochitests = addMockCommand(unittest_steps.MozillaPackagedMochitests)
MockMozillaPackagedXPCShellTests = addMockCommand(unittest_steps.MozillaPackagedXPCShellTests)
MockMozillaPackagedReftests = addMockCommand(unittest_steps.MozillaPackagedReftests)
RetryingMockCommand = addRetryEvaluateCommand(MockCommand)
RetryingMockProperty = addRetryEvaluateCommand(MockProperty)
RetryingMockScratchboxProperty = addRetryEvaluateCommand(buildbotcustom.steps.misc.ScratchboxProperty)
