...
tegra_errors = (
    (re.compile("process killed by signal 9"), RETRY), # bug 686084
    (re.compile("process killed by signal 15"), RETRY), # bug 660480
    (re.compile("FAIL: failed to initialize browser"), RETRY), # bug 686085
    (re.compile("FAIL: timeout exceeded"), EXCEPTION), # bug 675297
    (re.compile("command timed out: 1200 seconds without output, killing pid"), RETRY), # bug 686084 
